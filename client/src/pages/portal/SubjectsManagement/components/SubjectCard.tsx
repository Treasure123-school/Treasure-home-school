        ...
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <Badge variant="outline" className="text-[10px] mt-0.5 pointer-events-none" data-testid={`text-subject-code-${subject.id}`}>
                {subject.code}
              </Badge>
            </div>
          </div>
          ...
          <div className="flex flex-col items-end gap-1 shrink-0">
            <Badge className={`text-[10px] border-0 pointer-events-none ${cat.color}`} data-testid={`text-category-${subject.id}`}>
              {cat.label}
            </Badge>
            {archived && (
              <Badge className="text-[10px] border-0 pointer-events-none bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300" data-testid={`badge-archived-${subject.id}`}>
                Archived
              </Badge>
            )}
          </div>
