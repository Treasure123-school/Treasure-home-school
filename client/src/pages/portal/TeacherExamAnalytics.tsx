      ...
      {analytics && !isLoading && (
        <>
          ...
          <div className="grid gap-3 grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
            ...
            <StatCard icon={XCircle} label="Failed" value={analytics.overview.failCount} sub={`${analytics.overview.totalStudents - analytics.overview.passCount} students`} color="text-red-500" testId="fail-count" />
          </div>
