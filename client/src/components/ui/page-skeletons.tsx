...
export function AdminDashboardSkeleton() {
  return (
    <div className="animate-in fade-in duration-200" data-testid="skeleton-admin-dashboard">
      {/* Welcome Banner — mirrors: bg-gradient-to-r from-red-600 via-rose-600 to-pink-600 rounded-2xl p-6 shadow-lg */}
      <div className="mb-6 bg-gradient-to-r from-red-600 via-rose-600 to-pink-600 rounded-2xl p-6 shadow-lg">
        <div className="flex items-center gap-4">
          {/* Icon box — mirrors: bg-white/20 backdrop-blur-sm rounded-2xl p-4 */}
          <div className="bg-white/20 rounded-2xl p-4 flex-shrink-0">
            <SkeletonShimmer className="h-10 w-10 bg-white/30" />
          ...
          <div className="space-y-2 flex-1 min-w-0">
            <SkeletonShimmer className="h-8 w-48 sm:w-56 bg-white/30" />
            <SkeletonShimmer className="h-4 w-56 sm:w-72 bg-white/20" />
          </div>
        </div>
      </div>

      {/* Stats Grid — mirrors: grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        {[1, 2, 3, 4].map((i) => (
          <SkeletonShimmer key={i} className="h-32 w-full rounded-xl" />
        ))}
      </div>

      {/* Main Content — mirrors: grid grid-cols-1 lg:grid-cols-3 gap-6 */}
