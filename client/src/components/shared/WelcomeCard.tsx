  ...
  return (
    <div
      className={cn(
        ...
        "bg-gradient-to-r",
        gradient,
        /* Fluid padding: 12px on tiny phones → 20px on tablets → 24px on desktop */
        "p-3 sm:p-5 md:p-6",
        className
      )}
      data-testid={testId}
        ...
        <div className="flex items-center gap-2.5 sm:gap-4 flex-1 min-w-0">
          ...
          >
            <Icon
              className={cn(
                "text-white",
                /* Fluid icon: 20px → 28px → 40px */
                "h-5 w-5 sm:h-7 sm:w-7 md:h-10 md:w-10"
              )}
            />
          </div>
