...
function buildRouteTable(): RouteEntry[] {
  return [
    ...
    { pattern: '/portal/teacher/exams/manage', crumbs: [{ label: 'Dashboard', href: '/portal/teacher' }, { label: 'Exam System' }] },
    ...
    { pattern: '/portal/admin/exams/manage', crumbs: [{ label: 'Dashboard', href: '/portal/admin' }, { label: 'Exams' }] },
