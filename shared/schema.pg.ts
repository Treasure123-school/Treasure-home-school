...
export const systemSettings = pgTable("system_settings", {
  ...
  defaultTheme: varchar("default_theme", { length: 20 }).default('light'),
...
export const reportCardItems = pgTable("report_card_items", {
  ...
  reportCardItemsUniqueSubject: uniqueIndex("report_card_items_unique_subject_idx").on(table.reportCardId, table.subjectId),
}));
